...
//创建数据库 第一次项目运行才会调用
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = "create table typetb(id integer primary key autoincrement,typename varchar(10),imageId integer,sImageId interger,kind integer)";
        db.execSQL(sql);
        insertType(db);
        //创建记账表
    ...
    private void insertType(SQLiteDatabase db) {
        ...
        db.execSQL(sql,new Object[]{"水煤电", R.mipmap.ic_shuidianfei,R.mipmap.ic_shuidianfei_fs,0});
        db.execSQL(sql,new Object[]{"通讯", R.mipmap.ic_tongxun,R.mipmap.ic_tongxun_fs,0});
        db.execSQL(sql,new Object[]{"人情往来", R.mipmap.ic_renqingwanglai,R.mipmap.ic_riyongpin_fs,0});
